...
void Visualizer::SetIndexVector(pcl::PointCloud<pcl::PointXYZ>& input, double voxel_size) {
  index_vector.clear();
...
void Visualizer::Voxelize(pcl::PointCloud<pcl::PointXYZ>& input, pcl::PointCloud<pcl::PointXYZ>& output,
...
void Visualizer::ExtractLine(pcl::PointCloud<pcl::PointXYZ>& v_input,
...
void Visualizer::HSVtoRGB(int h, int s, int v, int& r, int& g, int& b) {
  int i2 = h / 43;
...
void Visualizer::VisualizeVoxel(pcl::PointCloud<pcl::PointXYZ>& input, double voxel_size) {
  visualization_msgs::MarkerArray marker_array;
...
void Visualizer::VisualizeLine(std::vector<std::pair<pcl::PointXYZ, pcl::PointXYZ>>& lines) {
  visualization_msgs::MarkerArray marker_array;
  visualization_msgs::Marker marker;
...
void Visualizer::VisualizeLineDensity(std::vector<std::pair<pcl::PointXYZ, pcl::PointXYZ>>& lines, double voxel_size) {
  visualization_msgs::MarkerArray marker_array;
  visualization_msgs::Marker marker;
  for (int i = 0; i < lines.size(); i++) {
...
void Visualizer::GrabPC(const sensor_msgs::PointCloud2& input) {
  ResetMarker();
  // convet input to xyz
